    ...
    },
    {
        ...
        children: [
            ...
            // },
            {
                ...
                name: 'app-upload',
                title: 'app文件上传',
                component: resolve => { require(['./views/my_components/file-upload/app-upload.vue'], resolve); }
            },
            // {
            //     path: 'count-to',
            ...
            //     name: 'app-qrcode',
            //     title: 'app二维码',
            //     component: resolve => { require(['./views/my_components/app-qrcode/app-qrcode.vue'], resolve); }
            // },
            {
                path: 'app-qrcode-water',
                icon: 'arrow-graph-up-right',
                name: 'app-qrcode-water',
                title: 'app二维码',
                component: resolve => { require(['./views/my_components/app-qrcode/app-qrcode-waterfall.vue'], resolve); }
            }
        ]
    },
    // {
